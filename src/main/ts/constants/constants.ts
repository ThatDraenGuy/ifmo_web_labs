...
export const GRAPH_HIT_COLOR = 'rgba(0, 255, 0, 1)'
export const GRAPH_INVALID_HIT_COLOR = 'rgba(0, 255, 0, 0.7)'
export const GRAPH_MISS_COLOR = 'rgba(255, 0, 0, 1)'
export const GRAPH_INVALID_MISS_COLOR = 'rgba(255, 0, 0, 0.7)'